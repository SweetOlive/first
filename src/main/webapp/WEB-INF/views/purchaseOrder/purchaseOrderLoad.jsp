...
<div class="modal-dialog ">
	<div class="modal-content">
		...
		<form id="userForm" action="${pageContext.request.contextPath}/purchaseOrder/save" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
			<div class="modal-body">
				...
				<div class="form-body">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" placeholder="" value="${purchaseOrder.name}" name="name">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" placeholder="" value="${purchaseInquiry.code}" name="code">
						<div class="form-control-focus"></div>
					...
					<div class="form-group form-md-line-input ">
						...
						<div class="col-md-8">
							<textarea class="form-control" name="introduce" rows="3">${purchaseOrder.introduce}</textarea>
							<div class="form-control-focus"></div>
					...
					<div class="form-group form-md-line-input ">
						...
						<div class="col-md-8">
							<textarea class="form-control" name="remark" rows="2">${purchaseOrder.remark}</textarea>
							<div class="form-control-focus"></div>
...
<script type="text/javascript">
    ...
    function myDialogAjaxDone(json){
        dialogAjaxDone(json);
        refreshSideBarRedPointByType("ORDER_APPROVER_NUM");
    }
