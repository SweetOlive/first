...
<div class="modal-dialog ">
	<div class="modal-content">
		...
		<form id="userForm" action="${pageContext.request.contextPath}/purchaseReceiving/save" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
			<div class="modal-body">
				...
				<div class="form-body">
					...
					<div class="form-group form-md-line-input ">
						...
						<div class="col-md-8">
							<textarea class="form-control" name="remark" rows="2">${purchaseReceiving.remark}</textarea>
							<div class="form-control-focus"></div>
...
<script type="text/javascript">
    ...
    function myDialogAjaxDone(json){
        dialogAjaxDone(json);
        refreshSideBarRedPointByType("RECEIVING_APPROVER_NUM");
    }
