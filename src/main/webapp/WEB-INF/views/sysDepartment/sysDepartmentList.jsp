...
<ul class="page-breadcrumb breadcrumb">
	...
	<li><span class="active">部门管理</span></li>
	
</ul>
<!-- END PAGE BREADCRUMB -->
<form class="form-horizontal" id="pagerForm" method="post" action="${pageContext.request.contextPath}/sysDepartment/list" onsubmit="return divSearch(this,'page-content')">
</form>
<div class="">
				...
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-list"></i> <span
							class="caption-subject sbold uppercase">所有部门</span>
					</div>
					...
					<div class="actions">
						...
						<a
							...
							href="${pageContext.request.contextPath}/sysDepartment/load?id="
							target="dialog"><i class="fa fa-asterisk"></i>&nbsp;修改</a> 
						<a
							id="seaDepartmentDelete" class="btn red btn-sm" todoMsg="确定删除部门？"
							href="${pageContext.request.contextPath}/sysDepartment/delete?id="
								...
								.jstree(
										{
											"core" : {
												...
												"data" : {
													'url' : function(node) {
														//return '${pageContext.request.contextPath}/admin/seaDepartment/listBody';
														return '${pageContext.request.contextPath}/sysDepartment/jsonList';
													}
												}
											},
											"types" : {
