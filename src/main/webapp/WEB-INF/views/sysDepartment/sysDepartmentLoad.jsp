...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<form id="pojoForm" action="${pageContext.request.contextPath}/sysDepartment/save" method="post" class="form-horizontal" id="form_sample_1" enctype="multipart/form-data">
			<div class="modal-body">
				...
				<div class="form-body">
					...
					<div class="row">
						...
						<div class="form-group form-md-line-input ">
							<label class="col-md-3 control-label" for="form_control_1">父部门 
							</label>
							<div class="col-md-8">
							<c:choose>
								<c:when test="${parentSysDepartment.id == 1 && sysDepartment==null}">
									<input type="text" value="无"class="form-control" disabled="disabled"/>	
								</c:when>
								<c:otherwise>
									<input type="text" value="${parentSysDepartment.name}"class="form-control" disabled="disabled"/>
								</c:otherwise>
							</c:choose>
						...
						<div class="form-group form-md-line-input ">
							<label class="col-md-3 control-label" for="form_control_1">部门名 <span class="required">*</span>
							</label>
							<div class="col-md-8">
								<input type="text" class="form-control required" placeholder="" value="${sysDepartment.name}" name="name">
								<div class="form-control-focus"></div>
				...
				<!--  
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-8">
								<textarea class="form-control" name="links" rows="3">${abtPermission.links}</textarea>
								<div class="form-control-focus"></div>
				...
				-->		
						<div class="form-group form-md-line-input">
							...
							<div class="col-md-8">
								<textarea class="form-control" name="introduce" rows="3">${sysDepartment.introduce}</textarea>
								<div class="form-control-focus"></div>
