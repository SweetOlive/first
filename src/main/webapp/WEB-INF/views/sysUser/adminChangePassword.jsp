...
<div class="modal-dialog ">
	<div class="modal-content">
		...
		<form id = "adminChangePasswordForm" action="${pageContext.request.contextPath}/admin/user/adminChangePassword"  method="post"
			class="form-horizontal" id="form_sample_1"
			enctype="multipart/form-data" >
			
			<input type="hidden" id="id" name="id" value="${abtUserId}">
...
/*         success1.hide();
    ...
    submitHandler: function(form) {
    	ajaxSubmitCallback($('#adminChangePasswordForm'), dialogAjaxDone);
    }
});
</script>
