								...
								<tr>
									...
									<td>
										<c:if test="${item.status eq 'A'}">
										    ...
										    <a target="ajaxTodo" todoMsg="是否确定删除这个进库料信息？" href="${pageContext.request.contextPath}/purchaseReceiving/delete?id=${item.id}" class="btn red btn-sm"><i class="fa fa-trash-o"></i>&nbsp;删除</a>
										</c:if>
